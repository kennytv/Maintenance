...
public final class MaintenanceBungeeCommand extends Command {
    ...
    public void execute(final CommandSender sender, final String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (args[0].equalsIgnoreCase("endtimer")) {
                ...
                final ProxiedPlayer player = plugin.getProxy().getPlayer(args[1]);
                if (player == null) {
                ...
                final ProxiedPlayer player = plugin.getProxy().getPlayer(args[1]);
                if (player == null) {
                    if (settings.removeWhitelistedPlayer(args[1].toLowerCase()))
                        sender.sendMessage(plugin.getPrefix() + "§aRemoved §b" + args[1].toLowerCase() + " §afrom the maintenance whitelist!");
                    else
    ...
    private void sendUsage(final CommandSender sender) {
        sender.sendMessage("");
        sender.sendMessage("§8===========[ §eMaintenanceBungee §8| §eVersion: §e" + plugin.getVersion() + " §8]===========");
